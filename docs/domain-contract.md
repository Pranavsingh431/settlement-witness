...
`docs/schema/v4/` is generated from them. Where this page and the code ever
...
The JSON Schema in `docs/schema/v4/` is generated by `make schema`. A test
